...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex justify-content-center">
                    <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                        <a class="navbar-brand brand-logo" href="index.php"><img style="width: 80%;" src="images/blanco-completo.png" alt="logo"/></a>
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                    <ul class="navbar-nav mr-lg-2">
                        <li class="nav-item ml-0">
                            <h4 class="mb-0" onclick="mostrarListarPanel(); return false;">Panel</h4>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link" href=""onclick="mostrarListarPanel(); return false;" >
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" onclick="mostrarListarSucursales(); return false;"  href="#">Sucursal</a></li>
                                    <li class="nav-item"> <a class="nav-link" onclick="mostrarListarUsuarioAdmin(); return false;"  href="#">Usuario Admin</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                    ...
                                    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted">Free <a href="https://www.bootstrapdash.com/" class="text-muted" target="_blank">Bootstrap s</a> templates from Bootstrapdash.com</span>
                                </div>
                            </div>    
                        </div>        
                    </footer>
        ...
        <!--<script src="vista/reservas.js"></script>-->
        <script src="vista/sucursal.js"></script>
        <script src="vista/usuario_admin.js"></script>
        <script src="vista/dias.js"></script>
        <script src="vista/profesional.js"></script>
